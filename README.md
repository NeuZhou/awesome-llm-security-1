...
- [ClawGuard](https://github.com/NeuZhou/clawguard): AI agent security scanner with 285+ threat patterns. Detects prompt injection, tool misuse, PII exposure, and more. GitHub Action available. ![GitHub Repo stars](https://img.shields.io/github/stars/NeuZhou/clawguard?style=social)
